...
class EndOfLifeClient {
    constructor() {
        this.httpClient = new httpm.HttpClient('JLLeitschuh/endoflife-date-matrix-action', undefined, { allowRetries: true, maxRetries: 3 });
    }
    ...
    fetchEOLDataAsJSON(url) {
        return __awaiter(this, void 0, void 0, function* () {
            return Array.from(JSON.parse(yield this.httpGetText(url))).map(({ cycle, eol, latest, link, lts, releaseDate, support }) => {
                return {
                    cycle,
                    eol: new Date(eol),
                    latest,
